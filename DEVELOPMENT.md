...
```bash
git remote add encore encore://chronic-symptom-tracker-rywi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/chronic-symptom-tracker-rywi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/chronic-symptom-tracker-rywi/settings/integrations/github)
